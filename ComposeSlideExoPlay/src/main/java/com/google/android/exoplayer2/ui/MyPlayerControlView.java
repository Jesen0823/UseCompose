...
public class MyPlayerControlView extends FrameLayout {
    ...
    @Nullable
    private final View fullScreenBtn; // add
    @Nullable
    ...
    public MyPlayerControlView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    public MyPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public MyPlayerControlView(
        ...
        if (fullScreenBtn != null) {
            fullScreenBtn.setOnClickListener(componentListener);
        }
    ...
    private final class ComponentListener
        ...
        public void onClick(View view) {
            ...
            } else if (fullScreenBtn == view) {
                mExoEventListener.changeFullScreen(player);
            }
        }
    }
    ...
    public void doPlay() {
        if (MyPlayerControlView.this.player == null) return;
        dispatchPlay(MyPlayerControlView.this.player);
    }

    public void doPause() {
        if (MyPlayerControlView.this.player == null) return;
        dispatchPause(MyPlayerControlView.this.player);
    }

    private ExoEventListener mExoEventListener;

    public void setExoEventListener(ExoEventListener exoEventListener) {
        this.mExoEventListener = exoEventListener;
    }
}
