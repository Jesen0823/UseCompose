...
public class MyPlayerView extends FrameLayout implements AdViewProvider {
    ...
    @Nullable
    private final MyPlayerControlView controller;
    @Nullable
    ...
    @Nullable
    private MyPlayerControlView.VisibilityListener controllerVisibilityListener;
    ...
    public MyPlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        MyPlayerControlView customController = findViewById(R.id.exo_controller);
        ...
        if (customController != null) {
            ...
            this.controller = new MyPlayerControlView(context, null, 0, attrs);
    ...
    public void setControllerVisibilityListener(
            @Nullable MyPlayerControlView.VisibilityListener listener) {
        Assertions.checkStateNotNull(controller);
    ...
    private final class ComponentListener
            ...
            OnClickListener,
            MyPlayerControlView.VisibilityListener {
    ...
    public MyPlayerControlView getPlayerController() {
