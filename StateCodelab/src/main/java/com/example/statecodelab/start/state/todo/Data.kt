...
import com.example.statecodelab.R
import java.util.UUID

data class TodoItem(
    val task: String,
    val icon: com.example.statecodelab.finish.state.todo.TodoIcon = com.example.statecodelab.finish.state.todo.TodoIcon.Default,
